	...
	<div class="container">
	  ...
	  <p>
	    ...
	    <c:if test="${vo.mid == sMid}">
	    	<a href="${ctp}/study/0428_database/update.jsp" class="btn btn-success mr-3">정보수정</a> &nbsp;
		    <a href="${ctp}/study/0428_database/memberMain.jsp" class="btn btn-success mr-3">회원탈퇴</a> &nbsp;
	    </c:if>
	  </p>
	</div>
	<p><br/></p>
