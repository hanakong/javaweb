...
<html>
	<head>
		<meta charset="UTF-8">
		<title>t2_SessionMain</title>
		<jsp:include page="/include/bs4.jsp" />
	</head>
	<body>
		<p><br/><p>
		<div class="container">
			<h2>세션 연습 메인메뉴</h2> <!-- session의 생명주기는 브라우저와 관련이 있다. -->
			<form name="myform" method="post" action="t2_SessionSave.jsp">
				...
				<div>
					세션 ID : <%=session.getId()%> <!-- 새로운 브라우저를 켤때마다 달라져요 -->
				</div>
				<div class="row">
					<div class="col"><button type="submit" class="btn btn-success form-control">제출</button></div>
