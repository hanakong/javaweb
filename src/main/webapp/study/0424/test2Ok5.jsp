...
<!-- 원래 사용법 value=폼태그에서 넘어오는 name // property= vo의 변수 --> --%>
...
<jsp:setProperty property="address" name="vo"/>
 --%>
<jsp:setProperty property="*" name="vo"/> <!-- vo의 변수값과 같으므로 *로 처리해도 가능! -->

<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>test2Ok5</title>
    ...
    <div>
      ...
      <p>
      	...
      	<a href="test26.jsp" class="btn btn-warning">돌아가기</a>
      </p>
    </div>
		</div>
		<p><br/><p>
