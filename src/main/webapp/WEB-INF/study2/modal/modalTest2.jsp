	...
	<head>
		...
		<script>
			...
			function fCheck() {
				...
				alert("성명 : " + name + ", 아이디 : " + mid + ", 닉네임 : " + nickName + ", 이메일 : " +email);
				location.reload();
			}
	...
	<jsp:include page="/include/header.jsp" />
		...
		<div class="container">
			...
			<p>
				...
				<input type="button" value="폼내용처리2" class="btn btn-info" data-toggle="modal" data-target="#myModal2"/>
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		        	<form name="modalForm" class="was-validated">
		        		성명 : 
		        		<input type="text" name="name" id="name" placeholder="성명을 입력해주세요" class="form-control mb-2" required/>
		        		<input type="button" value="성명확인" onclick="nameCheck()" class="btn btn-success form-control" />
		        		비밀번호 : 
		        		<input type="password" name="name" id="name" placeholder="성명을 입력해주세요" class="form-control mb-2" required/> 
		        	</form>
		        </div>
		        <!-- Modal footer -->
		    ...
		    <div class="modal-dialog modal-dialog-centered">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		        	<form name="modalForm" class="was-validated">
		        		성명 : 
		        		<input type="text" name="name" id="name" value="${vo.name}" placeholder="성명을 입력해주세요" class="form-control mb-2" required/>
		        		닉네임 : 
		        		<input type="text" name="nickName" id="nickName" value="${sNickName}" placeholder="닉네임을 입력해주세요" class="form-control mb-2" required/>
		        		아이디 : 
		        		<input type="text" name="mid" id="mid" value="${sMid}" placeholder="아이디를 입력해주세요" class="form-control mb-2" required/>
