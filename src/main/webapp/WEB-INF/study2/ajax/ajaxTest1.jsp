 ...
 // aJax를 이용한 아이디 검색
    function idCheck1() {
    	...
    	$.ajax({
    		...
    		charset : "uft-8",
    		success : function(res) { //callback 함수
...
<div class="container">
  ...
  <form name="myform">
    ...
    <hr/>
    aJax검색 : <br/>
    <input type="button" value="아이디검색1" onclick="idCheck1()" class="btn btn-primary"/><br/>
    <input type="button" value="아이디검색2" onclick="idCheck2()" class="btn btn-secondary"/><br/>
    <input type="button" value="아이디검색3" onclick="idCheck3()" class="btn btn-warning"/><br/>
    <input type="button" value="아이디검색4" onclick="idCheck4()" class="btn btn-danger"/><br/>
    <input type="button" value="아이디검색5" onclick="idCheck5()" class="btn btn-info"/><br/>
