					...
					<tr>
						<td>
							...
							<p>
								...
								<input type="button" value="확인(SHA256)" onclick="pwdCheck(3)" class="btn btn-success" />
							</p>
						</td>
					</tr>
				</table>
...
이때 256bit의 출력 길이를 갖는 SHA-2 암호화를 SHA-256, 512bit가 있다.
(SHA-256 해시 함수는 어떤 길이의 값을 입력하더라도 256비트의 고정된 결과값을 출력한다)
이름에 내포되어 있듯 2^{256}만큼 경우의 수를 만들수 있다.
