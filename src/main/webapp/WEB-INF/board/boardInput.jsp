		...
		<div class="container">
			...
			<form name="myform" method="post" action="${ctp}/BoardInputOk.bo">
				<table class="table table-bordered">
					...
					<tr>
						<th>홈페이지</th>
						<td><input type="text" name="homePage" id="homePage" placeholder="홈페이지 주소를 입력하세요" value="http://" class="form-control" /></td>
					</tr>
					<tr>
						<th>글내용</th>
					...
					<tr>
						<td colspan="2" class="text-center">
							<input type="button" value="글 올리기" onclick="fCheck()" class="btn btn-secondary" />
